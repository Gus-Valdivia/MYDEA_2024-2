...
<html>
    ...
    <body class="index">
        ...
        <%            con = new Conexion();
            ...
            r = stmt.executeQuery("select * from Negocio");
            int k = 0;
        ...
        <div class="information_index d-flex justify-content-around">
            <section class="w-25 h-100 card_info_in card_qs d-flex flex-column justify-content-between">
                ...
                <section class="d-flex flex-column text-white text_qs_card p-2 justify-content-evenly align-items-center">
                    ...
                    <span class="text_qs_card_ds">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nulla sint numquam quidem, at praesentium tempore vero reprehenderit magnam ad tempora aut quod sunt? Architecto ad aspernatur repellendus ipsam deleniti dolore.</span>
                </section>
            </section>
            <section class="w-25 h-100 card_info_in card_cmn d-flex flex-column justify-content-end">
                ...
                <section class="d-flex flex-column text-white justify-content-evenly align-items-center text_qs_card">
                    ...
                    <span class="text_qs_card_ds">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Et optio ea ex id voluptatum atque alias fuga consequatur ad tempore cum, provident impedit, ut totam quam vel sunt eum voluptas?</span>
                </section>
            </section>
            <section class="w-25 h-100 card_info_in card_eib d-flex flex-column justify-content-end">
                ...
                <section class="d-flex flex-column text-white justify-content-evenly align-items-center text_qs_card">
                    <span class="w-100 text_qs_card_tt justify-content-center">Encuentra los Insumos que Buscabas</span>
                    <span class="text_qs_card_ds">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Et optio ea ex id voluptatum atque alias fuga consequatur ad tempore cum, provident impedit, ut totam quam vel sunt eum voluptas?</span>
                </section>
            </section>
        </div>
        ...
        <div class="padd_lds">
            <div class="slid_neg d-flex flex-column">
                ...
                <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci sit laboriosam vero inventore
                    enim dolor suscipit! Qui, beatae? Corporis officia adipisci enim, alias aliquam quam vitae et
                    recusandae ipsum aut!</span>
                <button id="prev_lmn" class="btn prev prnx"><i class="bi bi-caret-left"></i></button>
                <button id="next_lmn" class="btn next prnx"><i class="bi bi-caret-right"></i></button>
                <div class="slider_i" id="slider_lmn">
                    ...
                    <form action="Negocio.jsp" >  
                        ...
                        <button type="submit" class="LMN_buttons">
                            <section class="card_i">

                                <section class="hover_infn"></section>
        ...
        <div class="slid_pro d-flex flex-column">
            ...
            <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci sit laboriosam vero inventore enim
                dolor suscipit! Qui, beatae? Corporis officia adipisci enim, alias aliquam quam vitae et recusandae
                ipsum aut!</span>
            <button id="prev_dtp" class="btn prev prnx"><i class="bi bi-caret-left"></i></button>
            <button id="next_dtp" class="btn next prnx"><i class="bi bi-caret-right"></i></button>
                ...
                <section class="card_pro_most card_pro_most_active">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex w-100 justify-content-between align-items-lg-center pr_inf_n">
                            ...
                            <span class="d-flex"><i class="bi bi-heart-fill"></i> <span class="num_calf_most"
                                                                                        id="num_calf_most">5</span></span>
                            <div id="com_most"><i class="bi bi-chat-square-dots-fill"></i><span class="num_com_most"
                                                                                                id="num_com_most">000010</span></div>
                        </div>
        ...
        <div class="Novedades_i">
            ...
            <div class="d-flex cont_nov_i">
                ...
                <section class="w-25 h-100 nuacmy_cont">
                    ...
                    <span class="na_txt">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Blanditiis assumenda laudantium illum! A numquam unde magnam ducimus repellat eligendi libero aliquid doloremque voluptates molestiae, minus esse debitis, magni laborum veniam.</span>
                </section>
            </div>
        </div>

        ...
        <div class="d-flex w-100 cni">
            <div class="d-flex flex-column w-75 h justify-content-center align-items-center txt_cni">
                <section class="d-flex flex-column w-75">
                    <span class="tittle_info_cn display-5">UNETE A MYDEA Y EMPIEZA A HACER CRECER TU NEGOCIO</span>
                    <span class="info_cn text-sm Inria">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, minus
                        quibusdam!
                        Ipsa repellendus, cupiditate nulla nisi at consequuntur porro sequi maiores molestiae magni.
                        Voluptates error, eius quia vitae repellat amet. Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Veritatis, obcaecati? Facilis nam placeat ipsam, tenetur, qui libero voluptatum excepturi, aut
                        dolore quae alias temporibus sit sint id dolorem et quis.</span>
                </section>
                ...
                <div class="h-50 w-100 d-flex align-items-center flex-column">
                    ...
                    <div class="d-flex w-100 beneficio m-2">
                        <section class="d-flex h-100 w-50 m-2">
                            ...
                            <span class="txt_cni text-white w-75 Inria">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Et architecto esse voluptas ad
                                alias labore minima! Beatae.</span>
                        </section>
                        <section class="d-flex h-100 w-50 m-2">

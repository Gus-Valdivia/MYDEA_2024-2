            ...
            <form class="w-100 container_is align-items-center justify-content-center flex-column subir" method="post" action="IniciarSesion" >
                <div class="is_form_container justify-content-between align-items-center">
                    ...
                    <ul class="d-flex list_inp_is justify-content-around">
                        <li><label for="Nom_usu_is">Nombre de Usuario</label><input type="text" id="Nom_usu_is" name="Nom_usu_is" class="form-control" placeholder=" Nombre de Usuario"></li>
                        <li><label for="Email_is">Correo Electronico</label><input type="email" id="Email_is" name="Email_is" class="form-control" placeholder=" Correo Electronico"></li>
                        <li><label for="Con_is">Contraseña</label><input type="password" id="Con_is" name="Con_is" class="form-control" placeholder=" Ingresar"></li>
                    </ul>
                    <span>¿Aún no tienes una cuenta? <a href="Registro.jsp" class="txt_os">REGISTRATE</a> </span>
                </div>
